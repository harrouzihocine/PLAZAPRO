<script setup>
// The "you left this unfinished" banner shown inside a form whose draft was
// restored. Informational only: a draft is never discarded by hand — it clears
// when the form is saved (or an oversight admin removes it).
