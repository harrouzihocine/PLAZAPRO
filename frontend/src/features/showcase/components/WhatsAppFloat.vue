...
<template>
  <a
    ...
    target="_blank"
    rel="noopener"
    class="fixed bottom-5 end-5 z-40 mb-[env(safe-area-inset-bottom)] flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-pop transition-transform hover:scale-105"
