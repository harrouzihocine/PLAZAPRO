...
echo "  2. Set COMPOSE_PROFILES=tunnel,lan-dns in .env (plus LAN_DNS_IP) so every"
echo "     deploy keeps the tunnel + office DNS running — runbook §1.5"
echo "  3. ./scripts/deploy.sh            (first deploy generates APP_KEY)"
