...
return [
    ...
    'units_guide_note' => 'كل سطر يمثّل وحدة واحدة. استبدل أسطر الأمثلة الرمادية ببياناتك ثم استورد الملف من صفحة الوحدات. اترك «reference» فارغًا ليُولَّد تلقائيًا. الأسطر التي تحمل عمود «id» (من ملف مُصدَّر) تُحدِّث الوحدة بدل إنشاء واحدة جديدة؛ ولا يغيّر الاستيراد حالة البيع أبدًا.',
    ...
    'units_guide_price_semi_fini' => 'سعر نصف مشطبة، بالدينار الجزائري.',
    'units_guide_price_fini' => 'سعر مشطبة، بالدينار الجزائري.',
