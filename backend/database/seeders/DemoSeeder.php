...
class DemoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $logCall->handle($c1, ['client_project_id' => $d1->id, 'agent_id' => $sarah->id, 'direction' => CallDirection::Outbound->value, 'outcome_id' => $this->item('call_outcomes', 'interested'), 'notes' => 'Prêt à signer.', 'called_at' => now()->subDays(3), 'next_action' => ['type' => NextActionType::SendDocs->value, 'due_at' => now()->addDay(), 'assigned_to' => $sarah->id]], $sarah);
        ...
        $logCall->handle($c3, ['client_project_id' => $d3->id, 'agent_id' => $sarah->id, 'direction' => CallDirection::Inbound->value, 'outcome_id' => $this->item('call_outcomes', 'interested'), 'notes' => 'Souhaite visiter le A-21.', 'called_at' => now()->subDays(2), 'next_action' => ['type' => NextActionType::ApartmentVisit->value, 'due_at' => now()->addDays(2), 'assigned_to' => $sarah->id]], $sarah);
        ...
        $visit->handle(['client_id' => $c3->id, 'client_project_id' => $d3->id, 'type' => VisitType::Apartment->value, 'unit_id' => $unitA21->id, 'agent_id' => $sarah->id, 'scheduled_at' => now()->addDays(2), 'notes' => 'Visite du A-21.']);
